    ...
    return Stack(
      children: <Widget>[
                        ...
                        children: <Widget>[
                          ...
                          new Padding(
                            padding: EdgeInsets.symmetric(
                                horizontal: 60 * SizeConfig.widthMultiplier!,),
        ...
        new Positioned(
          bottom: 0.0,
          child: new Container(
            height: 220 * SizeConfig.widthMultiplier!,
            width: MediaQuery.of(context).size.width,
            child: new Row(
              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
              children: <Widget>[
                new Container(
                  padding: EdgeInsets.all(15 * SizeConfig.widthMultiplier!,),
                  height: 80 * SizeConfig.widthMultiplier!,
                ...
                new Container(
                  padding: EdgeInsets.all(30 * SizeConfig.widthMultiplier!,),
                ...
                new Container(
                  ...
                  child: new ShaderMask(
                      child: new Icon(
                        Icons.star,
                        size: 65 * SizeConfig.heightMultiplier!,
                      ),
                      blendMode: BlendMode.srcATop,
                      shaderCallback: (Rect bounds) {
                        return LinearGradient(
                ...
                new Container(
                  ...
                  child: new ShaderMask(
                      child: new Icon(
                        Icons.favorite,
                        size: 65 * SizeConfig.widthMultiplier!,
                      ),
                      blendMode: BlendMode.srcATop,
                      shaderCallback: (Rect bounds) {
                        return LinearGradient(
